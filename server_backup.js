...
<title>Trimix | المنتج الأصلي</title>
...
<header class="header" style="display:flex; justify-content:space-between; align-items:center;">
  <div style="display:flex; align-items:center; gap:6px;">
    <button onclick="go('profile')" style="background:#f1f5f9; border:1px solid #cbd5e1; width:34px; height:34px; border-radius:50%; display:flex; align-items:center; justify-content:center; cursor:pointer; font-size:0.95rem;" title="الحساب الشخصي">👤</button>
    <button onclick="alert('لا توجد إشعارات جديدة حالياً 🔔')" style="background:#f1f5f9; border:1px solid #cbd5e1; width:34px; height:34px; border-radius:50%; display:flex; align-items:center; justify-content:center; cursor:pointer; font-size:0.95rem; position:relative;" title="الإشعارات">🔔<span style="position:absolute; top:-2px; right:-2px; background:#ef4444; color:#fff; font-size:0.5rem; width:14px; height:14px; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700;">1</span></button>
  </div>
  <div class="logo" id="ht">Trimix</div>
...
<div class="pm" id="pm">
  ...
  <div class="pm-b">
    ...
    <div class="box note-box"><div class="l">ملاحظات Trimix</div><div class="v" id="pm-note">—</div></div>
...
const titles={store:'Trimix',cart:'السلة',checkout:'إتمام الطلب',orders:'طلباتي',profile:'حسابي',withdraw:'سحب الأرباح',support:'الدعم'};
