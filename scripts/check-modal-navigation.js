...
const checks = [
  ...
  ['marketer dashboard has incremental live updates', html.includes('/api/affiliate/orders/updates') && html.includes('setInterval(refreshAffiliateLive,5000)') && html.includes('data-bottom-tab="orders"')],
  ['AI storefront surface is removed', !html.includes('storeAiMdl') && !html.includes('storeAiLaunch') && !html.includes('store-ai-')],
