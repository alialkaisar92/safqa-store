...
assert(html.includes('function updateCartPriceFromInput(i,value)'), 'instant cart price update is missing');
...
assert(html.includes('oninput="updateCartPriceFromInput('), 'cart price input must update immediately');
...
console.log('instant cart price editor: YES');
