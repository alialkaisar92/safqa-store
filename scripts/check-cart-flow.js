...
assert(html.includes('function saveAllCartPrices(options)'), 'bulk cart price save is missing');
assert(html.includes('cartPriceBulkActions'), 'bulk cart price actions are missing');
assert(html.includes("window.saveAllCartPrices({silent:true})"), 'checkout must save edited prices before opening');
