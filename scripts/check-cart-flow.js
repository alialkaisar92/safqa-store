...
assert(html.includes('سعر البيع للعميل') && html.includes('سعر البيع المعتمد من الإدارة'), 'cart must show the admin-controlled sale price');
...
assert(html.includes('readonly aria-readonly="true"'), 'product sale price must be readonly for marketers');
