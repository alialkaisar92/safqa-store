...
W.chgQty=function(d){var mx=_CUR && _CUR.stock != null ? Number(_CUR.stock) : 0;_QTY=Math.max(1,Math.min(mx,_QTY+d));var qv=G('qtyVal');if(qv)qv.textContent=_QTY;var sh=G('stockHint');if(sh)sh.style.display=(_QTY>mx)?'block':'none';};
